...
{
   filename    = "Add-Ons/GameMode_Rising_Lava/res/sounds/pushBroomHit.wav";
   description = AudioClosest3d;
   preload = true;
};
datablock AudioProfile(pushBroomSwingSound)
{
   filename    = "Add-Ons/GameMode_Rising_Lava/res/sounds/pushBroomSwing.wav";
...
datablock ItemData(pushBroomItem)
{
	...
	shapeFile = "Add-Ons/GameMode_Rising_Lava/res/shapes/pushBroom.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
